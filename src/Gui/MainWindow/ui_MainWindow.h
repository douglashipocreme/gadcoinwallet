...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/gadcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutgadcoinAction = new QAction(MainWindow);
        m_aboutgadcoinAction->setObjectName(QStringLiteral("m_aboutgadcoinAction"));
        m_aboutgadcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutgadcoinAction);
        ...
        QObject::connect(m_aboutgadcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutgadcoinAction->setText(QApplication::translate("MainWindow", "About gadcoin", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND GADCOINS", Q_NULLPTR));
