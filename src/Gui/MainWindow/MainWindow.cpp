...
const char COMMUNITY_FORUM_URL[] = "https://www.gadcoin.com.br";
const char REPORT_ISSUE_URL[] = "https://www.gadcoin.com.br/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Gadcoin Wallet %1").arg(Settings::instance().getVersion()));
